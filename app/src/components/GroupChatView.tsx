      ...
      <header className="relative flex-shrink-0 bg-white border-b border-gray-200 px-5 pt-5 pb-4 md:pl-5 pl-14">
        <div className="flex items-start justify-between">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium transition-colors ${manageOpen ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
          >
